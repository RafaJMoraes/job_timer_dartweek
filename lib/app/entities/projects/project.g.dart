...
const ProjectSchema = CollectionSchema(
  name: 'Project',
  schema:
      '{"name":"Project","idName":"id","properties":[{"name":"name","type":"String"},{"name":"projectStatus","type":"Long"}],"indexes":[],"links":[{"name":"tasks","target":"ProjectTask"}]}',
  idName: 'id',
  propertyIds: {'name': 0, 'projectStatus': 1},
  listProperties: {},
  indexIds: {},
  indexValueTypes: {},
  linkIds: {'tasks': 0},
...
void _projectSerializeNative(
  ...
  final value1 = _projectProjectStatusConverter.toIsar(object.projectStatus);
  final _projectStatus = value1;
  ...
  writer.writeLong(offsets[1], _projectStatus);
}
