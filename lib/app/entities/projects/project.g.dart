...
const ProjectSchema = CollectionSchema(
  name: 'Project',
  schema:
      '{"name":"Project","idName":"id","properties":[{"name":"estimate","type":"Long"},{"name":"name","type":"String"},{"name":"projectStatus","type":"Long"}],"indexes":[],"links":[{"name":"tasks","target":"ProjectTask"}]}',
  idName: 'id',
  propertyIds: {'estimate': 0, 'name': 1, 'projectStatus': 2},
  listProperties: {},
  indexIds: {},
  indexValueTypes: {},
  linkIds: {'tasks': 0},
...
void _projectSerializeNative(
  ...
  final value2 = _projectProjectStatusConverter.toIsar(object.projectStatus);
  final _projectStatus = value2;
  ...
  writer.writeLong(offsets[2], _projectStatus);
}

Project _projectDeserializeNative(IsarCollection<Project> collection, int id,
    IsarBinaryReader reader, List<int> offsets) {
  final object = Project();
  object.estimate = reader.readLongOrNull(offsets[0]);
  object.id = id;
...
dynamic _projectSerializeWeb(
  ...
  IsarNative.jsObjectSet(jsObj, 'projectStatus',
      _projectProjectStatusConverter.toIsar(object.projectStatus));
  return jsObj;
}
...
Project _projectDeserializeWeb(
  ...
  final object = Project();
  object.estimate = IsarNative.jsObjectGet(jsObj, 'estimate');
  object.id = IsarNative.jsObjectGet(jsObj, 'id');
  object.name = IsarNative.jsObjectGet(jsObj, 'name') ?? '';
  object.projectStatus = _projectProjectStatusConverter.fromIsar(
      IsarNative.jsObjectGet(jsObj, 'projectStatus') ??
...
P _projectDeserializePropWeb<P>(Object jsObj, String propertyName) {
  switch (propertyName) {
    case 'estimate':
      return (IsarNative.jsObjectGet(jsObj, 'estimate')) as P;
    case 'id':
...
extension ProjectQueryFilter
  ...
  QueryBuilder<Project, Project, QAfterFilterCondition> estimateIsNull() {
  ...
  QueryBuilder<Project, Project, QAfterFilterCondition> projectStatusEqualTo(
      ProjectStatus value) {
    return addFilterConditionInternal(FilterCondition(
      type: ConditionType.eq,
  ...
  QueryBuilder<Project, Project, QAfterFilterCondition> projectStatusLessThan(
    ProjectStatus value, {
    bool include = false,
  }) {
    return addFilterConditionInternal(FilterCondition(
  ...
  QueryBuilder<Project, Project, QAfterFilterCondition> projectStatusBetween(
    ProjectStatus lower,
    ProjectStatus upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension ProjectQueryWhereSortBy on QueryBuilder<Project, Project, QSortBy> {
  ...
  QueryBuilder<Project, Project, QAfterSortBy> sortByProjectStatus() {
    return addSortByInternal('projectStatus', Sort.asc);
  }

  QueryBuilder<Project, Project, QAfterSortBy> sortByProjectStatusDesc() {
    return addSortByInternal('projectStatus', Sort.desc);
  }
}
...
extension ProjectQueryWhereSortThenBy
  ...
  QueryBuilder<Project, Project, QAfterSortBy> thenByProjectStatus() {
    return addSortByInternal('projectStatus', Sort.asc);
  }

  QueryBuilder<Project, Project, QAfterSortBy> thenByProjectStatusDesc() {
    return addSortByInternal('projectStatus', Sort.desc);
  }
}
...
extension ProjectQueryWhereDistinct
  ...
  QueryBuilder<Project, Project, QDistinct> distinctByProjectStatus() {
    return addDistinctByInternal('projectStatus');
  }
}
...
extension ProjectQueryProperty
  ...
  QueryBuilder<Project, ProjectStatus, QQueryOperations>
      projectStatusProperty() {
    return addPropertyNameInternal('projectStatus');
  }
}
